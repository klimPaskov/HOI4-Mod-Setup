...
These 14 images are the primary full-resolution desktop implementation references. Every image is 1536 by 1024 pixels.
...
Revision 3 adds a compact ChatGPT sign-in gate before the existing project-selection reference. The 14 PNG files remain the visual-density and layout reference for the main wizard. Authentication behavior and copy are authoritative in `docs/17_ui_accessibility.md` and `docs/30_codex_chatgpt_authentication.md`.
